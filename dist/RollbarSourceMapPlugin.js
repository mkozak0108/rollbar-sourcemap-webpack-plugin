...
var RollbarSourceMapPlugin = function () {
  function RollbarSourceMapPlugin(_ref) {
    var accessToken = _ref.accessToken,
        ...
        _ref$limitParallelUpl = _ref.limitParallelUpload,
        limitParallelUpload = _ref$limitParallelUpl === undefined ? Infinity : _ref$limitParallelUpl,
  ...
  (0, _createClass3.default)(RollbarSourceMapPlugin, [{
    ...
    value: function uploadSourceMaps(compilation, cb) {
      ...
      var limit = this.limitParallelUpload;

      _async2.default.eachLimit(assets, limit, upload, function (err, results) {
        if (err) {
          return cb(err);
        }
